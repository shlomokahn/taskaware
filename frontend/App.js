...
const styles = StyleSheet.create({
    ...
    input: { flex: 1, height: 50, backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: '#e5e7eb', paddingHorizontal: 15, fontSize: 16, color: '#111827' },
    addBtn: { width: 50, height: 50, borderRadius: 12, backgroundColor: '#2f855a', alignItems: 'center', justifyContent: 'center' },
    addBtnDisabled: { opacity: 0.5 },
    addBtnText: { color: '#fff', fontSize: 24, fontWeight: '700' },
    error: { color: '#b91c1c', fontSize: 14, textAlign: 'center' },
    taskRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#fff', padding: 16, borderRadius: 12, marginBottom: 8, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 2, elevation: 2 },
    taskTitle: { fontSize: 16, color: '#111827', flex: 1 },
    completedText: { textDecorationLine: 'line-through', color: '#9ca3af' },
    statusIcon: { fontSize: 18, color: '#2f855a', fontWeight: '700', width: 24 },
