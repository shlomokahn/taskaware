...
const styles = StyleSheet.create({
    ...
    titleRow: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: 10, marginBottom: 14, marginTop: 4 },
    title: { flex: 1, fontSize: 22, fontWeight: '800', color: '#111827', textAlign: 'left', lineHeight: 30 },
    ...
    dateChip: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#fff', borderRadius: 14, padding: 12, marginBottom: 16, borderWidth: 1, borderColor: '#E5E7EB' },
    dateChipIcon: { fontSize: 22 },
    dateChipDay: { fontSize: 14, fontWeight: '700', color: '#1F2937', textAlign: 'left' },
    dateChipTime: { fontSize: 13, color: '#6B7280', textAlign: 'left' },
    ...
    aiSubtitle: { fontSize: 13, color: '#6B7280', marginBottom: 12, textAlign: 'left' },
    ...
    placesList: { gap: 10 },
    placeItem: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#fff', borderRadius: 14, padding: 12, borderWidth: 1, borderColor: '#E5E7EB' },
    ...
    placeName: { fontSize: 15, fontWeight: '800', color: '#111827', textAlign: 'left' },
    placeAddress: { fontSize: 12, color: '#6B7280', textAlign: 'left', marginTop: 2 },
    placeMeta: { fontSize: 11, color: '#7C3AED', marginTop: 4, textAlign: 'left', fontWeight: '600' },
    openIcon: { fontSize: 18, color: '#7C3AED', fontWeight: '800' },
    iconRow: { flexDirection: 'row', gap: 10, marginBottom: 16 },
    iconTile: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#fff', borderRadius: 14, paddingVertical: 13, borderWidth: 1, borderColor: '#E5E7EB' },
